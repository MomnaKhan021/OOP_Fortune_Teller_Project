...
public:
    void Welcome()  // Welcome Screen
    {
        ...
        cout << "                                              YES! WE KNOW ALL ABOUT YOU ;) " << endl << endl;
        cout << "                               ********************************************************" << endl;
        cout << endl << endl << endl;
        cout << "Project made by = " << endl;
        cout << "    *Sumayyah Sayyed   " << endl;
        cout << "    *Momna Khan        " << endl;
        cout << "    *Ayesha Umar       " << endl;
        cout << "    *Ayesha Asif       " << endl << endl;
        cout << "########################################################################################################################" << endl;
        cout << "########################################################################################################################" << endl;
        cout << "        ------------------------------------------------------------------------------------------------------" << endl;
        cout << endl;
    ...
    void Display()      // To display users information
    {
        ...
        {
            if ((month > 12) || (month == 2 && date > 30) || (month == 1, 3, 5, 7, 8, 10, 12 && date > 31) || (month == 2, 4, 6, 9, 11 && date > 30) || (year > 2020) || (year == 0))
            {
                cout << endl << endl;
    ...
    void Horoscope()        // Function to set the stars range
    {
        ...
        {
            star = "ARIES";
            cout << "                                     -------------- You are an " << star <<"--------------"<< endl << endl << endl;
            cout << "                                                                                 *      *   " << endl;
            cout << "                                                                                *  *   *  * " << endl;
            cout << "                                                                               *    * *    *" << endl;
            cout << "                                                                                     *      " << endl;
...
int main()
{
    ...
    do
    {
        cout << endl << endl << "                       -------------------Here are your choices-------------------" << endl << endl;
        cout << "                           1. About Yourself" << "                        " << "2. Fortunes" << endl;
        cout << "                           3. Lucky numbers" << endl << endl;
    ...
    if ((again == 'n') || (again == 'N'))       //End screen
    {
        ...
        cout << "                               ********************************************************" << endl << endl;
        cout << "                                                        THANK YOU!" << endl;
        cout << "                                               WE HOPE YOU LIKED OUR GAME :) " << endl << endl;
        cout << "                                                   COME BACK ANY TIME :)" << endl << endl;
        cout << "                               ********************************************************" << endl;
        cout << endl << endl << endl << endl << endl << endl;
        cout << "########################################################################################################################" << endl;
        cout << "########################################################################################################################" << endl;
